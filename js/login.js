...
//VALIDACIÓN DE INICIO DE SESIÓN
    if (user.value && pass.value) {                                      //Si hay valores puestos en los inputs (campos) user y password...
      localStorage.setItem("Usuario", user.value);                       //...se carga a localStorage un objeto identificador (user.value) con etiqueta "Usuario"...
      window.location.href = "./index.html";                             //...una vez que reconoce los valores y se cargó lo que se tiene que cargar en localStorage, redirige a index.html
    }
  });
});